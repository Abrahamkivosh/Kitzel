...
Route::post('create-payment', function () {
    $apiContext = new \PayPal\Rest\ApiContext(
        new \PayPal\Auth\OAuthTokenCredential(
            'AXSgV0gUK6Vwj3rLMabBiUWzto4BrQW5LqsAPzV1eJhOLM7HTPm06RdMuBNYGYKPZDXmC83sMaEvWfUc',     // ClientID
            'EKoz1IZ7St7RNqCF2FMr2LPd-0bjBNC-rTs5HaEctSIp3D6FKRKuElf3DUhGfA2Ea14sydqzD0yBFrMZ'      // ClientSecret
        )
    );
